...
status, msg = request_helper.get_logs({"appId" : "001"})
print("GET 001: Recibi {} logs, con status {}".format(len(msg.get('logs')), msg))

logs = [{"appId" : "001", "msg" : "primer log", "tags" : "error", "timestamp" : "2019-02-01 09:30:20.120000"},
 {"appId" : "001", "msg" : "segundo log", "tags" : "error", "timestamp" : "2019-02-02 15:00:20.120000"},
 {"appId" : "001", "msg" : "tercer log", "tags" : "info", "timestamp" : "2010-02-01 12:45:20.120000"},
 {"appId" : "001", "msg" : "cuarto log", "tags" : "info", "timestamp" : "2008-02-01 21:05:20.120000"},
 {"appId" : "001", "msg" : "quinto log, relacionado con el segundo", "tags" : "info healthcheck", "timestamp" : "2019-02-01 09:35:20.120000"}]
...
for log in logs:
    status, msg = request_helper.post_log(log)
    print("POST 001: envie {} y recibi {} con status {}".format(log, msg.get('msg'), status))
